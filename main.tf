...
#Creating the maintenance window module for PatchingProdONE-APAC-rebootifneeded
...
module "PatchingProdONE-APAC-rebootifneeded_AWS_MAINTENANCE_WINDOW_TARGET" {
  source                                     = "./MAINTENANCE_WINDOW/TARGETS"
  ssm_maintenance_window_id                  = module.PatchingProdONE-APAC-rebootifneeded_AWS_MAINTENANCE_WINDOW.SSM_WINDOW_MAINTENANCE_WINDOW_ID
  ssm_maintenance_window_target_name         = "PRD-APAC-ONE"
  ssm_maintenance_window_target_resourcetype = "RESOURCE_GROUP"
  ssm_maintenance_window_target_key          = ["resource-groups:Name"]
  ssm_maintenance_window_target_value        = ["APAC-ONE-PRD"]
}
...
module "PatchingProd-Corpo-Fashion-VP-WFJEservices_AWS_MAINTENANCE_WINDOW_TARGET" {
  source                                     = "./MAINTENANCE_WINDOW/TARGETS"
  ssm_maintenance_window_id                  = module.PatchingProd-Corpo-Fashion-VP-WFJEservices_AWS_MAINTENANCE_WINDOW.SSM_WINDOW_MAINTENANCE_WINDOW_ID
  ssm_maintenance_window_target_resourcetype = "RESOURCE_GROUP"
  ssm_maintenance_window_target_key          = ["resource-groups:Name", "resource-groups:Name", "resource-groups:Name", "resource-groups:Name"]
  ssm_maintenance_window_target_value        = ["WFJ_ESERVICES_PRD", "FASHION-PRD", "CORPO-PRD", "EMEA_VP_PROD"]
}
...
module "RebootNonProdMiniSites_AWS_MAINTENANCE_WINDOW_TARGET" {
  source                                     = "./MAINTENANCE_WINDOW/TARGETS"
  ssm_maintenance_window_id                  = module.RebootNonProdMiniSites_AWS_MAINTENANCE_WINDOW.SSM_WINDOW_MAINTENANCE_WINDOW_ID
  ssm_maintenance_window_target_resourcetype = "RESOURCE_GROUP"
  ssm_maintenance_window_target_key          = ["resource-groups:Name"]
  ssm_maintenance_window_target_value        = ["MINISITES-NONPROD"]
}
...
module "PachingProdMinisitesRHEL9_AWS_MAINTENANCE_WINDOW_TARGET" {
  source                                     = "./MAINTENANCE_WINDOW/TARGETS"
  ssm_maintenance_window_id                  = module.PachingProdMinisitesRHEL9_AWS_MAINTENANCE_WINDOW.SSM_WINDOW_MAINTENANCE_WINDOW_ID
  ssm_maintenance_window_target_name         = "ProdMinisitesRhel9Target"
  ssm_maintenance_window_target_description  = "Resource Group for Minisites Prod Rhel 9"
  ssm_maintenance_window_target_resourcetype = "RESOURCE_GROUP"
  ssm_maintenance_window_target_key          = ["resource-groups:Name"]
  ssm_maintenance_window_target_value        = ["RHEL9-prod"]
}
...
module "RebootNonProd_AWS_MAINTENANCE_WINDOW_TARGET" {
  source                                     = "./MAINTENANCE_WINDOW/TARGETS"
  ssm_maintenance_window_id                  = module.RebootNonProd_AWS_MAINTENANCE_WINDOW.SSM_WINDOW_MAINTENANCE_WINDOW_ID
  ssm_maintenance_window_target_resourcetype = "INSTANCE"
  ssm_maintenance_window_target_key          = ["tag:Patch Group", "tag:project", "tag:project", "tag:project", "tag:project", "tag:project"]
  ssm_maintenance_window_target_value        = ["non-prod", "corpo", "eservices", "fashion", "vp", "wfj-chanel-com"]
}
...
module "RebootNonProdONE_AWS_MAINTENANCE_WINDOW_TARGET" {
  source                                     = "./MAINTENANCE_WINDOW/TARGETS"
  ssm_maintenance_window_id                  = module.RebootNonProdONE_AWS_MAINTENANCE_WINDOW.SSM_WINDOW_MAINTENANCE_WINDOW_ID
  ssm_maintenance_window_target_resourcetype = "RESOURCE_GROUP"
  ssm_maintenance_window_target_key          = ["resource-groups:Name"]
  ssm_maintenance_window_target_value        = ["ONE-nonprod"]
}
...
module "PachingNonProdMinisitesRHEL9_AWS_MAINTENANCE_WINDOW_TARGET" {
  source                                     = "./MAINTENANCE_WINDOW/TARGETS"
  ssm_maintenance_window_id                  = module.PachingNonProdMinisitesRHEL9_AWS_MAINTENANCE_WINDOW.SSM_WINDOW_MAINTENANCE_WINDOW_ID
  ssm_maintenance_window_target_name         = "ProdMinisitesRhel9Target"
  ssm_maintenance_window_target_resourcetype = "RESOURCE_GROUP"
  ssm_maintenance_window_target_key          = ["resource-groups:Name"]
  ssm_maintenance_window_target_value        = ["RHEL9-nonprod"]
}
...
module "PatchingProdONE-AMER-rebootifneeded_AWS_MAINTENANCE_WINDOW_TAREGT" {
  source                                     = "./MAINTENANCE_WINDOW/TARGETS"
  ssm_maintenance_window_id                  = module.PatchingProdONE-AMER-rebootifneeded_AWS_MAINTENANCE_WINDOW.SSM_WINDOW_MAINTENANCE_WINDOW_ID
  ssm_maintenance_window_target_name         = "PRD-AMER-ONE"
  ssm_maintenance_window_target_resourcetype = "RESOURCE_GROUP"
  ssm_maintenance_window_target_key          = ["resource-groups:Name"]
  ssm_maintenance_window_target_value        = ["ONE-AMER-PRD"]
}
...
module "PatchingMinisitePRD_AWS_MAINTENANCE_WINDOW_TARGET" {
  source                                     = "./MAINTENANCE_WINDOW/TARGETS"
  ssm_maintenance_window_id                  = module.PatchingMinisitePRD_AWS_MAINTENANCE_WINDOW.SSM_WINDOW_MAINTENANCE_WINDOW_ID
  ssm_maintenance_window_target_resourcetype = "RESOURCE_GROUP"
  ssm_maintenance_window_target_key          = ["resource-groups:Name"]
  ssm_maintenance_window_target_value        = ["MINISITES"]
}
...
module "PatchingProdONE-EMEA-rebootifneeded_AWS_MAINTENANCE_WINDOW_TARGET" {
  source                                     = "./MAINTENANCE_WINDOW/TARGETS"
  ssm_maintenance_window_id                  = module.PatchingProdONE-EMEA-rebootifneeded_AWS_MAINTENANCE_WINDOW.SSM_WINDOW_MAINTENANCE_WINDOW_ID
  ssm_maintenance_window_target_name         = "ONE-EMEA-PRD"
  ssm_maintenance_window_target_resourcetype = "RESOURCE_GROUP"
  ssm_maintenance_window_target_key          = ["resource-groups:Name"]
  ssm_maintenance_window_target_value        = ["EMEA-ONE-PROD"]
}
